...
<?= Form::open(array('url' => 'admin/q_tests/del/'.$id)) ?>
<?= Form::token() ?>
    <div class="row">
        <div class="large-12 columns">
            <h4>Удалить вопрос | <a href="/admin/qlist?type=test">Все вопросы на слова</a></h4>
        </div>
    </div>
    <div class="row">
        <div class="large-12 columns">
    ...
    <div class="row">
        <div class="large-12 columns">
            ...
            <a href="/admin/q_tests" class="button">Нет, верни меня обратно</a>
        </div>
    </div>
